...
""",
  ...
  node(label) {
    ...
    def violin_book_repo = checkout([
      ...
      userRemoteConfigs: [[
        credentialsId: '2448e943-479f-4796-b5a0-fd3bf22a5d30',
        url: 'https://gitee.com/guan-xiangwei/violin-calendar.git'
        ]]
      ])
    ...
    def imageEndpoint = "violin/violin-calendar"
      ...
      script{
        ...
        wrap([$class: 'BuildUser']) {
          withCredentials([usernamePassword(
            ...
            """
            sh "sed -i -e s/tagUpdateTime:.*/tagUpdateTime:' '${localDateTime}/g ./prod/violin-calendar-deployment-prod.yaml"
            sh "sed -i -e s/violin-calendar:.*/violin-calendar:${imageTag}/g ./prod/violin-calendar-deployment-prod.yaml"
            sh "git add ./prod/violin-calendar-deployment-prod.yaml"
